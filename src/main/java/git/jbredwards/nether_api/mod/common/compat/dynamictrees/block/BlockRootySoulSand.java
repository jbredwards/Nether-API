 ...
 *
 */
public final class BlockRootySoulSand extends AbstractBlockRooty
{
    @Nonnull
    public static final BlockRootySoulSand INSTANCE = new BlockRootySoulSand();
    private BlockRootySoulSand() { super("rooty_soulsand", Material.SAND, false); }

    @Nonnull
    @Override
    public EnumPlantType getSoilType() { return PlantUtils.SOUL_SAND_PLANT_TYPE; }

    @Nonnull
    @Override
    protected Block getFallbackMimic() { return Blocks.SOUL_SAND; }
