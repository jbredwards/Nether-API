...
import git.jbredwards.nether_api.api.event.NetherInitBiomeGensEvent;
...
public class BiomeProviderNether extends BiomeProvider
{
    public BiomeProviderNether(@Nonnull WorldType worldType, long seed) {
        final GenLayer[] biomeGenerators = getModdedBiomeGenerators(worldType, seed, getBiomeGenerators(seed));
    ...
    @Nonnull
    public GenLayer[] getBiomeGenerators(long seed) {
    ...
    public GenLayer[] getModdedBiomeGenerators(@Nonnull WorldType worldType, long seed, @Nonnull GenLayer[] original) {
        final NetherInitBiomeGensEvent event = new NetherInitBiomeGensEvent(worldType, seed, original);
