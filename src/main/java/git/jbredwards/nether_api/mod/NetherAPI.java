...
public final class NetherAPI
{
    ...
    public static final String MODID = "nether_api", NAME = "Nether API", VERSION = "1.3.0", DEPENDENCIES =
            ...
            "after:betternether@[0.1.8.6,);after:biomesoplenty@[7.0.1.2444,);after:journey@1.0.6.11;after:nethercraft@1.0.2;after:netherex@[2.2.5,);after:stygian@[1.0.4,);";
    ...
    // Fix modded entity spawn biomes (like the BetterNether firefly)
    @Mod.EventHandler
